...
#include <stdlib.h>
#include "./wasm-rt.h"
//#include "tut-fromWasm.h" //! ie, a hard-coded name: can refer to "tmp.h" (for some cases)
#include "tmp.h" //! ie, a hard-coded name: can refer to "tmp.h" (for some cases)
/**
gcc -o fac tut-mainProg.c tmp.c wasm-rt-impl.c -lm
 **/
