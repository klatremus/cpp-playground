//! Src: https://en.cppreference.com/w/cpp/memory/shared_ptr
// FIXME: get below to work ... undetand how "std::make_shared" works with "std::Vector" ... thus, wrriewt he te belwo!
#include <memory>
#include <iostream>
...
struct Container : std::enable_shared_from_this<Container> // note: public inheritance
{
  ...
  std::shared_ptr<MyObj> GetAsMyObj()
  {
    ...
    return std::shared_ptr<MyObj>(shared_from_this(), memberObj.get()); // FIXME: what does the "shared_from_this()" perofmr=do?
  }
};
